...
const timelineData = [
  {
    ...
    description: 'A vacina Quintupla (V5) deve ser aplicada entre 45 e 60 dias de vida do gato. E somente com exame de Sorologia negativo para Leucemia e Imunodeficiência Felina.',
  },
  {
...
export default function QuintuplaTimeLine() {
    return(
        <div className="flex flex-col items-center justify-center px-6 py-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-10">
                Cronograma para Vacinação Quintupla
              </h2>
